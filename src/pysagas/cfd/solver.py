...
from pysagas import CellArray, FlowState, Vector
...
class FlowSolverVec(AbstractFlowSolver):
    def __init__(
        self,
        cells: CellArray,
        ...
        ----------
        cells : CellArray
            Cell data in numpy array format
    ...
    def save(self, name: str, attributes: Dict[str, list]):
        ...
        cells = self.cells.reconstruct()
        # TODO: Check this is neceessary. The less reconstructing the better
        faces = []
        vertex_faces = {}
    ...
    @staticmethod
    def body_to_wind(v: np.Array, aoa: float):
